...
public class NewsActivity extends AppCompatActivity implements LoaderCallbacks<List<NewsReport>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<NewsReport> highlights = new ArrayList<NewsReport>();

        // Create a new adapter that takes an empty list of earthquakes as input
        newsAdapter = new NewsReportAdapter(getApplicationContext(), highlights);
        ...
        newsList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Uri newsUri = Uri.parse(currentNewsReport.getUrl());
    ...
    @Override
    public android.content.Loader<List<NewsReport>> onCreateLoader(int i, Bundle bundle) {
    ...
    @Override
    public void onLoadFinished(android.content.Loader<List<NewsReport>> loader, List<NewsReport> newsReports) {
    ...
    @Override
    public void onLoaderReset(android.content.Loader<List<NewsReport>> loader) {
